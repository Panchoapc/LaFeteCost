...
class MaquinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maquina" do
    assert_difference('Maquina.count') do
      post maquinas_url, params: { maquina: { CostoHora: @maquina.CostoHora, Maquina_id: @maquina.Maquina_id, NombreMaquina: @maquina.NombreMaquina } }
    end
  ...
  test "should update maquina" do
    patch maquina_url(@maquina), params: { maquina: { CostoHora: @maquina.CostoHora, Maquina_id: @maquina.Maquina_id, NombreMaquina: @maquina.NombreMaquina } }
