...
class OperariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operario" do
    assert_difference('Operario.count') do
      post operarios_url, params: { operario: { CostoHora: @operario.CostoHora, TipoOperario: @operario.TipoOperario } }
    end
  ...
  test "should update operario" do
    patch operario_url(@operario), params: { operario: { CostoHora: @operario.CostoHora, TipoOperario: @operario.TipoOperario } }
