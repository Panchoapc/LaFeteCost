...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { CodProd: @producto.CodProd, CostoMatPrima: @producto.CostoMatPrima, Detalle: @producto.Detalle, Nombre: @producto.Nombre } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { CodProd: @producto.CodProd, CostoMatPrima: @producto.CostoMatPrima, Detalle: @producto.Detalle, Nombre: @producto.Nombre } }
